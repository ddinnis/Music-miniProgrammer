...
__DEFINE__(1664702946422, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1664702946423,"./event-store":1664702946424}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664702946423, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1664702946424, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1664702946423,"./utils":1664702946425}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1664702946425, function(require, module, exports) {
...
return __REQUIRE__(1664702946422);
})()
